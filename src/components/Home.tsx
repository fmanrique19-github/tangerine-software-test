            ...
            user.isLogin ?
                <div>
                    ...
                    <MDBContainer className="tangerine-container" fluid>
                        <MDBRow>
                            <Albums albums={albums} md={this.state.mdAlbums} displayPhotos={this.displayPhotos} classAlbumsMobile={this.state.classAlbumsMobile} />
                            <Photos photos={photos} md={this.state.mdPhotos} className={this.state.classPhotos} title={this.state.title} displayAlbums={this.displayAlbums} />
                        </MDBRow>
                    </MDBContainer>
                    <Footer />
                </div>
